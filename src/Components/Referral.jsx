...
<<<<<<< HEAD
            <div className=" text-left inline-block w-80 bg-slate-100 border mt-3 pb-3 px-3 pt-3 rounded-xl">
=======
...
>>>>>>> 8c4548b0e583389af37d22e9a7e1cdb6540b817f
          ...
          <div className='flex justify-center items-center'>
<<<<<<< HEAD
            <div className="text-left inline-block w-80  bg-slate-100 border pb-3 px-3 pt-3 rounded-xl mt-4">
=======
